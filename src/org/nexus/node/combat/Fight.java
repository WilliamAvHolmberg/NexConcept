...
public class Fight extends Node {
	...
	public void attackNewTarget() {
		...
		if (target != null && !methodProvider.map.canReach(target)) {
			...
			Sleep.sleepUntil(() -> target.isUnderAttack(), 150, 5000);
	...
	public void combatSleep() {
		Sleep.sleepUntil(() -> (Eat.shallEat(methodProvider) || !playerIsAttacking()) || getInteractingNPC() == null
	...
	public int setCombatTask(CombatTask task) {
